...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Form Registrasi : {{CRUDBooster::getSetting('appname')}}</title>
  ...
  <body class="login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <p class='login-box-msg'>Please Fill Your Data</p>
        <form autocomplete='off' action="{{ route('postSignup') }}" method="post">
          <input type="hidden" name="_token" value="{{ csrf_token() }}" />
          <div class="form-group has-feedback">
            <input autocomplete='off'  type="text" class="form-control" name='name' required placeholder="Name"/>
          ...
          <div style="margin-bottom:10px" class='row'>
            <div class='col-xs-12'>
                <button type="submit" class="btn btn-primary btn-block btn-flat"><i class='fa fa-lock'></i> Sign Up</button> 
                <a href="../../admin" class="btn btn-success btn-block btn-flat"> <i class='fa fa-user'></i> Sign In</a>                
            </div>
          </div>       
        </form>
